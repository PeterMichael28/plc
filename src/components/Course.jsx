...
const Course = ({title, prices, img, p}) => {
 return (
  <div className="flex flex-col space-y-3  h-auto w-[89%] xs:w-[360px] items-center py-4 px-3 mx-auto mb-4 m-2 cursor-pointer shadow hover:shadow-xl shadow-[#5E6282] transition-all duration-[.4s]">
